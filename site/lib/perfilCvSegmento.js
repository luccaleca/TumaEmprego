...
export const PERFIS = {
  "dados-bi-analytics": {
    ...
    expTitulo: "Ótica Santo Grau — Estagiário em Análise de Dados",
  ...
  desenvolvimento: {
    ...
    projetosOmitir: [],
    expTitulo: "Ótica Santo Grau — Automação com Python e SQL (apoio técnico a dados comerciais)",
  ...
  "marketing-growth": {
    ...
    expTitulo: "Ótica Santo Grau — Estagiário em Growth Marketing / Análise de Dados",
    expNota:
      "Growth orientado a dados: segmentação, KPIs, Power BI e impacto de +20% na receita (R$ 50k → R$ 60k).",
    resumoExtra:
  ...
  "ia-ml": {
    ...
    projetosOmitir: ["Tuma Emprego"],
    expTitulo: "Ótica Santo Grau — Análise de Dados aplicada a decisões de produto",
...
export function buildResumoPerfil(perfil, ctx) {
  ...
  const paragrafo = `${objetivo}. Estudante de Sistemas de Informação (IMT, 7º sem.) com entregas em ${perfil.stack}. Na Ótica Santo Grau, atuei com SQL, Python e Power BI gerando insights e dashboards — incluindo contribuição para **+20% de receita** (R$ 50k → R$ 60k). ${perfil.resumoExtra}`;
