...
export function montarValoresEstruturaSolides() {
  ...
  return {
    ...
    formacao_grau: txt(form0.grau_curso || fonte.formacao?.grau),
    formacao_curso: txt(fonte.formacao?.curso || form0.grau_curso),
    ...
    formacao_fim: txt(form0.fim || fonte.formacao?.previsao_formatura),
